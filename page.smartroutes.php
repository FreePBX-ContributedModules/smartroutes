...
function smartroutes_edit($id) {
	...
	echo('<form name="smartroutes_routeEdit" id="smartroutes_routeEdit" action="" method="post">'."\n");
	...
	foreach ($smartroute_queries as $query) {
		...
		echo('<tr><td><nobr><img src="?handler=file&module=smartroutes&file=trash.png.php" style="float:none; margin-left:0px; margin-bottom:-3px; cursor:pointer;" alt="'._("remove").'" title="'._('Click here to remove this query').'" onclick="queryRemove('._("$query_row").')">');
	...
	foreach ($smartroute_dests as $dest) {
    	...
    	// uses js function queryRemove(row)
		echo('<tr><td valign="top"><nobr><img src="?handler=file&module=smartroutes&file=trash.png.php" style="float:none; margin-left:0px; margin-bottom:-3px; cursor:pointer;" alt="'._("remove").'" title="'._('Click here to remove this destination').'" onclick="destRemove('._("$destRowsUsed").')">');
...
$(document).ready(function(){
	...
	$("#smartroutes-dest-add").click(function(){
		...
		var insert_html = '<?php
		    ...
		    echo('<tr><td><nobr><img src="?handler=file&module=smartroutes&file=trash.png.php" style="float:none; margin-left:0px; margin-bottom:-3px; cursor:pointer;" alt="'._("remove").'" title="'._('Click here to remove this destination').'" onclick="destRemove('._("$destRowsUsed").')">');
